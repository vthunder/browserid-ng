    ...
    E: EmailSender + 'static,
{
    ...
    let registrar = browserid_registrar::router(Arc::new(
        browserid_registrar::RegistrarState {
            ...
            // The login page (registry-api-v1 §4.2 `login_page`): the
            // account password.
            login_page_url: Some(format!(
                "{}/registry-login",
    ...
    let mut app = Router::new()
        ...
        .route(
            ...
            get(hosted_idp::tenant_management_get).post(hosted_idp::tenant_management_set),
        )
        ...
        .route_service("/registry-login", ServeFile::new(format!("{}/registry-login.html", static_path)))
...
const INLINE_SCRIPT_HASHES: &[&str] = &[
    "'sha256-gUiAUZAWNRxe+r4pp8vnKe3YLk4hB6uXJ9Tm0eKYo1I='", // account.html
