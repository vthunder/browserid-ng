 ...
 * @returns {Uint8Array}
 */
export function objectHash(wire) {
    const ptr0 = passArray8ToWasm0(wire, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.objectHash(ptr0, len0);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {Uint8Array}
 */
export function payloadComment(body, parent, created_at) {
    const ptr0 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(parent, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.payloadComment(ptr0, len0, ptr1, len1, !isLikeNone(created_at), isLikeNone(created_at) ? BigInt(0) : created_at);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @param {bigint | null} [expires]
 * @returns {Uint8Array}
 */
export function payloadMembership(subject, issuer, issued_at, expires) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.payloadMembership(ptr0, len0, ptr1, len1, issued_at, !isLikeNone(expires), isLikeNone(expires) ? BigInt(0) : expires);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function payloadPost(body, parent, created_at) {
    const ptr0 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(parent) ? 0 : passStringToWasm0(parent, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.payloadPost(ptr0, len0, ptr1, len1, !isLikeNone(created_at), isLikeNone(created_at) ? BigInt(0) : created_at);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function payloadReaction(target, kind, state) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.payloadReaction(ptr0, len0, ptr1, len1, state);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function signingBytes(opts) {
    const ret = wasm.signingBytes(opts);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sbo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
