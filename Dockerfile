...
COPY browserid-verifier/Cargo.toml browserid-verifier/
...
RUN mkdir -p browserid-core/src browserid-dnssec/src browserid-registrar/src browserid-verifier/src browserid-broker/src browserid-agent/src browserid-rp/src && \
    ...
    echo "pub fn dummy() {}" > browserid-verifier/src/lib.rs && \
    ...
    rm -rf browserid-core/src browserid-dnssec/src browserid-registrar/src browserid-verifier/src browserid-broker/src browserid-agent/src browserid-rp/src
...
COPY browserid-verifier/src browserid-verifier/src
...
RUN touch browserid-core/src/lib.rs browserid-dnssec/src/lib.rs browserid-registrar/src/lib.rs browserid-verifier/src/lib.rs browserid-agent/src/lib.rs browserid-rp/src/lib.rs browserid-broker/src/main.rs && \
    cargo build --release --package browserid-broker
