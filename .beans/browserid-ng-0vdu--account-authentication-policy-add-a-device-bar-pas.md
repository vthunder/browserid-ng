...
updated_at: 2026-09-15T16:12:47Z
...
2026-09-15 evening: cookie-session leak found by Dan (address list shown to an unadmitted incognito browser); client gate shipped; the server-side rule is scoped in docs/plans/2026-09-15-cookie-session-admission-handoff.md → bean 160l (fresh session).
