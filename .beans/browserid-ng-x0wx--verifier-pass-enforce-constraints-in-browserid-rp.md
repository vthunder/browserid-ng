...
## Summary of Changes
Core Constraints/AudConstraint + managed marker + AccessRequest.audience; enforcement in AccessPresentation::verify (both presented certs, unknown keys fail closed). 9 core tests; golden vectors unchanged. Deployed in broker a04ddf7; mingo pin bumped. SBO on-chain verifier audit still open (tracked in epic).
