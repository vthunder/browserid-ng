# OIDC bridge — design plan

**Date:** 2026-08-02
**Status:** design sketch, not yet scheduled. Companion to
`2026-08-02-roadmap-directions.md` (Theme 1's headline item).
Builds on the claim-time authority hierarchy and the dialog claim-hop
machinery shipped for handle identities (epic browserid-ng-tsqk; design in
`2026-07-30-handle-identities-and-the-authority-hierarchy.md`).
